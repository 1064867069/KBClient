...
public class kerberos {
	public static String getlength(int length) {//长度转换
		String len="";
		if(length<10) {
	...
	//AS解析从client发过来的包
	public static String[] AS_parseClient(String packageFromClient) {
	...
	//生成as->client的数据包
		public static String asToClient(String Kc, String Ktgs, String Kctgs, String IDc, String ADc, String IDtgs) {
